...
const schemas = {
    ...
    cadastroUsuario: Joi.object({
        ...
        email: Joi.string().email().required()
            ...
            .messages({
                ...
                'email.institucional': 'Email deve ser institucional (@univali.br ou @edu.univali.br)',
        ...
        senha: Joi.string().min(8).required()
            ...
            .messages({
                ...
                'password.weak': 'Senha deve conter pelo menos: 1 letra minúscula, 1 maiúscula e 1 número',
    ...
    criarGrupo: Joi.object({
        ...
        materia: Joi.string().min(2).max(100).required()
            .messages({
        ...
        objetivo: Joi.string().min(10).max(500).required()
            .messages({
        ...
        local: Joi.string().valid('online', 'presencial').required()
            .messages({
                'any.only': 'Local deve ser "online" ou "presencial"',
                'any.required': 'Local é obrigatório'
            }),
        limite_participantes: Joi.number().integer().min(2).max(50).required()
            .messages({
    ...
    resetSenha: Joi.object({
        ...
        nova_senha: Joi.string().min(8).required()
            .custom((value, helpers) => {
                if (!validarSenha(value)) {
                    return helpers.error('password.weak');
                }
            ...
            .messages({
                ...
                'password.weak': 'Nova senha deve conter pelo menos: 1 letra minúscula, 1 maiúscula e 1 número',
